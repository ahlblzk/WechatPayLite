...
class WechatPay {
    ...
    //     'APPID'              => 'wx0dad88d1899f736e', // 微信支付APPID
    //     'MCHID'              => '1499176392', // 微信支付MCHID 商户收款账号
    //     'KEY'                => '11df00554430aec99219dc56a210a17c', // 微信支付KEY
    //     'APPSECRET'          => 'cd51833cc814e3d083a10bedf50ab5ab',  //公众帐号secert
    //     'NOTIFY_URL'         => 'https://tongzhuang.lizekun.com/Tinyapi/pay/notify', // 接收支付状态的回调域名
    //     );
...
//     [return_code] => SUCCESS
//     [return_msg] => OK
//     [appid] => wx79fb6f504fe2a1d0
//     [mch_id] => 1290988701
//     [nonce_str] => vRwLAYrMek5O0nxt
//     [sign] => 6A8B4A6E66D37598861395E6F1BB1E86
//     [result_code] => SUCCESS
//     [prepay_id] => wx0822455570844473baff61f11929941867
//     [trade_type] => JSAPI
// )
        // 显示错误信息
    ...
    **/
     ...
     */
    public function getParameters($openid,$out_trade_no,$info){
        // 获取配置项
        $config=$this->config;
        ...
        //     $openid=$result['openid'];
            ...
            $order=array(
                ...
                'total_fee'=>$info['money']*100,// 订单金额  以(分)为单位（需要根据自己的业务修改）
